...
function YouTubeEmbed({ videoId }: { videoId: string }) {
    return (
        <div className="aspect-video w-full rounded-lg overflow-hidden shadow-2xl border-2 border-primary/20 bg-black">
            <iframe
    ...
    return (
        <div className="grid md:grid-cols-2 gap-8 p-6 text-lg text-foreground/90 h-full">
            <div className="flex flex-col justify-center">
                 <ScrollArea className="flex-grow pr-4 -mr-4 h-96">
                    {showQuiz ? (
                        ...
                        <div className="flex flex-col justify-between h-full">
                            <p className="flex-grow leading-relaxed text-base">{currentMessage}</p>
