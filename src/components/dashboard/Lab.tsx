...
export function Lab() {
  return (
    <Accordion type="single" collapsible defaultValue="item-1" className="w-full space-y-4">
      <AccordionItem value="item-1" className="border-border/50 rounded-lg border bg-card/50 px-4">
      ...
      <AccordionItem value="item-2" className="border-border/50 rounded-lg border bg-card/50 px-4">
        <AccordionTrigger className="text-xl font-headline data-[state=open]:text-primary hover:no-underline">
          <div className="flex items-center gap-3">
      ...
      <AccordionItem value="item-3" className="border-border/50 rounded-lg border bg-card/50 px-4">
        <AccordionTrigger className="text-xl font-headline data-[state=open]:text-primary hover:no-underline">
          <div className="flex items-center gap-3">
