  ...
  (
    ...
    return (
      <aside
        ...
        data-side={side}
        className={cn(
          'group hidden text-sidebar-foreground md:flex flex-col h-svh transition-[width] ease-linear',
          'w-[--sidebar-width] data-[collapsible=offcanvas]:w-0',
          variant === 'floating' || variant === 'inset'
            ? 'data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))_!important]'
